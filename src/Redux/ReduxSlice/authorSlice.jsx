...
export const deleteAuthor = createAsyncThunk(
  ...
  async (authorId, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(error.response?.data || 'Failed to delete author');
    }
  }
);
...
export const createAuthor = createAsyncThunk(
  ...
  async (newAuthor, { rejectWithValue }) => {
    try {
      const response = await axios.post(`${BASE_URL}/createAuthor`, newAuthor, {
        headers: {
...
export const updateAuthor = createAsyncThunk(
  'author/updateAuthor',
  async ({ id, updatedAuthor }, { rejectWithValue }) => {
    try {
      const response = await axios.put(`${BASE_URL}/updateAuthor/${id}`, updatedAuthor);
      return response.data.result;
    } catch (error) {
      return rejectWithValue(error.response?.data || 'Failed to update author');
    }
  }
);
