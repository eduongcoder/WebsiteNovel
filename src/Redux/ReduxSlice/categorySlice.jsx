...
//                 // Kiểm tra xem state.categories có phải là mảng và không undefined
//                 console.log('Action payload:', action.payload);
//                 console.log('State categories before filtering:', state.categories);
...
//                 } else {
//                     console.error(
//                         'state.categories is not an array or is undefined',
//                     );
//                     state.categories = []; // Gán lại mảng rỗng để tránh lỗi
//                 }
//             })
